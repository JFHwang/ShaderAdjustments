...
${OBJECTDIR}/BasicParticles.o: BasicParticles.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BasicParticles.o BasicParticles.cpp

${OBJECTDIR}/BoundingSphere.o: BoundingSphere.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BoundingSphere.o BoundingSphere.cpp

${OBJECTDIR}/Brick.o: Brick.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Brick.o Brick.cpp
...
${OBJECTDIR}/DrawData.o: DrawData.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DrawData.o DrawData.cpp
...
${OBJECTDIR}/Frustum.o: Frustum.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Frustum.o Frustum.cpp
...
${OBJECTDIR}/Geode.o: Geode.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Geode.o Geode.cpp
...
${OBJECTDIR}/KeyTracker.o: KeyTracker.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/KeyTracker.o KeyTracker.cpp
...
${OBJECTDIR}/MathTestBench.o: MathTestBench.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MathTestBench.o MathTestBench.cpp
...
${OBJECTDIR}/MatrixNode.o: MatrixNode.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MatrixNode.o MatrixNode.cpp
...
${OBJECTDIR}/Movable.o: Movable.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Movable.o Movable.cpp
...
${OBJECTDIR}/OBJObject.o: OBJObject.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/OBJObject.o OBJObject.cpp

${OBJECTDIR}/Paddle.o: Paddle.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Paddle.o Paddle.cpp
...
${OBJECTDIR}/SmartGeode.o: SmartGeode.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SmartGeode.o SmartGeode.cpp
...
${OBJECTDIR}/UpdateData.o: UpdateData.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/UpdateData.o UpdateData.cpp
...
${OBJECTDIR}/Vector4.o: Vector4.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Vector4.o Vector4.cpp
